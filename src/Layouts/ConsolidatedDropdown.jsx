...
export function ConsolidatedDropdown() {
  return (
    <Popover>
      ...
      >
        <Popover.Panel className="sm:absolute flex flex-col py-1 divide-y-2 divide-orange-300 justify-between gap-1 right-14 md:right-32 2xl:right-[400px] lg:right-80 top-56 md:top-8 mt-2 w-52 h-fit origin-center md:origin-top-right dark:bg-zinc-800 bg-zinc-50 rounded-md border-none outline-none shadow-sm">
          <BasicHooksDropmenu />
          <InterHooksDropmenu />
        </Popover.Panel>
      </Transition>
