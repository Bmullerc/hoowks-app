...
export function ConsolidatedDropdown() {
  return (
    <Popover>
      <Popover.Button
        className="inline-flex items-center w-full justify-center hover:cursor-pointer hover:text-orange-500 transition-all duration-150 ease-out hover:ease-in active:text-orange-500"
      >
        Content
        <CaretDown
