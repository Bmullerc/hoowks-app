    ...
    <header id="header" className="flex justify-center items-center h-screen dark:bg-zinc-700 text-zinc-700 bg-zinc-200 tracking-tight dark:bg-gradient-to-b from-current to-orange-400 bg-gradient-to-t">
      <div className="text-center text-zinc-800">
        ...
        <h1 className="lg:text-7xl text-6xl font-bold">
          ...
          <span className="text-orange-300 pl-4 tracking-tighter uppercase lg:text-6xl text-6xl inline-block md:hover:scale-125 transition-all hover:translate-x-4 duration-200 drop-shadow-md">
            How
          </span>
        </h1>
        <h2 className="lg:text-5xl text-4xl font-bold">to
          <span className="inline-block px-4 py-1 text-orange-200 tracking-wider font-bold uppercase lg:text-6xl text-5xl transition-all duration-200 md:hover:scale-125 hover:translate-y-2 ease-in-out drop-shadow-md">
            Use
          </span>
          them.
        </h2>
