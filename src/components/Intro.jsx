export function Intro() {
  return (
    <section className="border-b-2 border-zinc-300 mb-20">
      ...
      <p className="mt-8 text-sm">You can read more in-depth information in the official documentation, <a href="https://reactjs.org/docs/hooks-intro.html" className="font-medium hover:text-orange-500">Hooks Intro</a></p>


      <h2 id="intro" className="lg:text-4xl text-3xl font-bold mt-16">Hook Rules</h2>
      <h3 id="intro" className="lg:text-2xl text-xl font-bold mt-8">Only Call Hooks at the Top Level</h3>
      <p className="mt-6"><strong className="text-orange-500">Don’t call Hooks inside loops, conditions, or nested functions.</strong> Instead, always use Hooks at the top level of your React function, before any early returns. By following this rule, you ensure that Hooks are called in the same order each time a component renders. That’s what allows React to correctly preserve the state of Hooks between multiple useState and useEffect calls. </p>

      <h3 id="intro" className="lg:text-2xl text-xl font-bold mt-6">Only Call Hooks from React Functions</h3>
      ...
      <p className="mt-6">By following this rule, you ensure that all stateful logic in a component is clearly visible from its source code.
      </p>
