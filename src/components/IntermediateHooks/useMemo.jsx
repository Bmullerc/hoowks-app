...
export function UseMemo() {
  return (
    <article id="memo" className='border-b-2 border-orange-300 my-20 pb-20'>
      ...
      <HotTip children={<p className="dark:text-zinc-700">Think of memoization as caching a value so that it does not need to be recalculated. You can check more about it <a href='/extra/#memo' className='text-orange-600 hover:text-zinc-100 rounded-sm'>here</a>.</p>}/>
